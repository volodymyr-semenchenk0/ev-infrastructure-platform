...
- Інтерактивна матриця `m × m`, де `m` — кількість критеріїв; брати її з API/схеми динамічно, не зашивати число в компонент.
...
- Маркери локацій-кандидатів у межах м. Київ — кольорове кодування за рангом відносно загальної кількості локацій (не за фіксованими індексами):
  - Зелений (#10B981): верхня третина рейтингу
  - Жовтий (#F59E0B): середня третина
  - Червоний (#EF4444): нижня третина
- Popup на маркер: ID, назва, район, усі значення критеріїв локації, ранг в обох профілях.
