...
Таблиця Г.4. – Опис атрибутів таблиці `criterion_values`
...
Таблиця Г.5. – Опис атрибутів таблиці `locations`
...
Таблиця Г.6. – Опис атрибутів таблиці `existing_stations`
...
Таблиця Г.7. – Опис атрибутів таблиці `evaluation_runs`
...
Таблиця Г.8. – Опис атрибутів таблиці `ranking_items`
...
Таблиця Г.9. – Опис атрибутів таблиці `sensitivity_records`
